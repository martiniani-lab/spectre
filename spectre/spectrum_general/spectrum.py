...
if __name__ == '__main__':
    # mat = torch.tensor([[-44.24, -42.1, -53.62, -10.95, -39.27],
    #                 [-42.40, -65.80, -70.96, -31.47, -30.29],
    #                 [-53.62, -70.96, -82.78, -27.67, -38.75],
    #                 [-10.95, -31.47, -27.67, -26.46, -6.51],
    #                 [-39.27, -30.29, -38.75, -6.51, -41.65]])

    # mat = torch.tensor([[-2.0518, -0.3601,  0.5610, -0.7787, -0.2385],
    #                     [-0.2652, -1.2410, -0.0250, -0.2682,  0.2613],
    #                     [ 0.8794, -0.0098, -1.4837,  0.9539, -0.2238],
    #                     [-0.0477, -0.1631,  0.3845, -0.8069,  0.0787],
    #                     [ 0.1053,  0.4375, -0.3633,  0.1227, -0.5337]])

    # mat = torch.tensor([[-1.2185, -0.7876, -0.6846, 1.8951, -1.1435],
    #                     [-0.8781, 1.8710, -0.5482, 0.9888, 1.1185],
    #                     [-0.8034, 0.8713, 0.5619, -1.5262, 0.1283],
    #                     [1.4638, -0.1300, -0.1721, 1.4715, -0.9747],
    #                     [-0.4311, 0.4965, -2.2822, -0.3467, 0.2090]])
